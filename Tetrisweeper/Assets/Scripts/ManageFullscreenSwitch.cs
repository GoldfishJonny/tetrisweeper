...
public class ManageFullscreenSwitch : MonoBehaviour
{
    ...
    {
        Screen.SetResolution(_fullscreenWidth, _fullscreenHeight, FullScreenMode.FullScreenWindow, Screen.currentResolution.refreshRateRatio);
    ...
    {
        Screen.SetResolution(_halfscreenWidth, _halfscreenHeight, FullScreenMode.Windowed, Screen.currentResolution.refreshRateRatio);
